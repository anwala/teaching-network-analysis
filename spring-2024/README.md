...
|---|---|---|---|
|1|Jan 25          | Introductions                        | [Network Science - Chapter 1: Introduction (Barabasi)](http://networksciencebook.com/chapter/1) <br/> [Networks, Crowds and Markets - Chapter 1: Overview (Easley & Kleinberg)](http://www.cs.cornell.edu/home/kleinber/networks-book/networks-book-ch01.pdf) <br/> [HW0](homework/hw0) - Writing reports, Jan 26 -- Feb 5
|2|Jan 30 & Feb 1  | Network Elements                     | [Network Science - Chapter 2: Graph Theory (Barabasi)](http://networksciencebook.com/chapter/2) <br/> [Networks, Crowds and Markets - Chapter 2: Graphs (Easley & Kleinberg)](http://www.cs.cornell.edu/home/kleinber/networks-book/networks-book-ch02.pdf) <br/> [Python Google Colab notebook](week-2/data_340_02_s23_chp_01_network_elements.ipynb)
|3|Feb 6 & 8       | Network Analysis toolkit             | [Network Datasets 1](http://konect.cc/) <br/> [Network Datasets 2](http://networkrepository.com/) <br/> [HW1](homework/hw1) - Network Elements/Analysis toolkit, Feb 6 -- 20
...
|5|Feb 20 & 22     | Node centrality (importance) metrics | [Wikipedia: Centrality](https://en.wikipedia.org/wiki/Centrality)
|6|Feb 27/29 & Mar 5 | Link Analysis                      | [PageRank.nlogo](week-6/PageRank.nlogo) <br/> [Graph structure in the Web (Broder et al., 2000)](https://doi.org/10.1016/S1389-1286(00)00083-9) <br/> [Python Google Colab notebook](week-4/data_340_02_s23_chp_03_hubs.ipynb)<br/>[HW3](homework/hw3) - Hubs, Feb 28 -- Mar 9
